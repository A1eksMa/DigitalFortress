...
1. **WebSocket** — совместим с CDN, похож на чаты и уведомления
2. **gRPC** — HTTP/2, мультиплексирование, похож на микросервисы
3. **XHTTP (splithttp)** — разбивает соединение на короткие HTTP-запросы
